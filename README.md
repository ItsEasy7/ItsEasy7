# 👋 Привет! Меня зовут Роберт Бухаров
...
> **Backend/Fullstack разработчик** с более чем **4 годами опыта** работы в разработке микросервисов и монолитов.
> 
